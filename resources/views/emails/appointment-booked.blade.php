...
<body>
    <div class="container">
        <div class="header">
            ...
            <p style="margin: 10px 0 0; font-size: 14px; opacity: 0.9;">APPOINTMENT REQUESTED</p>
        </div>
        <div class="content">
            <h2 style="margin-top: 0; font-style: italic;">Hello {{ $appointment->first_name }}!</h2>
            <p style="color: #999; line-height: 1.6;">Your appointment request for the <strong>{{ $appointment->car_name }}</strong> has been received successfully. We will review your request and get back to you shortly.</p>
            ...
            <div class="info-box">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="color: #ef4444; font-weight: bold;">Rs {{ number_format($appointment->total_price) }}</td>
                    </tr>
                </table>
            </div>

            <p style="color: #888; text-align: center; margin-top: 30px;">You can track your appointment status in your profile.</p>
